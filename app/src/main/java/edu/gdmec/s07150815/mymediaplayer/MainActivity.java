package edu.gdmec.s07150815.mymediaplayer;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (player.isPlaying()) {
                    int currrentPosition = player.getCurrentPosition();
                    if (currrentPosition - 10000 > 0) {
                        player.seekTo(currrentPosition - 10000);
                    }
                }
            }
        });
